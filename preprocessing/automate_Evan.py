...
def run_preprocessing():
    ...
    # 1. Mengambil lokasi folder persis tempat script ini berada
    current_dir = os.path.dirname(os.path.abspath(__file__))
    
    # 2. Menggabungkan jalur secara absolut ke folder dataset_raw
    ...
    print(f"Selesai! Data bersih berhasil diperbarui dan disimpan di:\n{clean_path}")
    return df_clean
